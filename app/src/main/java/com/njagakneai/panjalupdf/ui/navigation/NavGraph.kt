package com.njagakneai.panjalupdf.ui.navigation
...
import com.njagakneai.panjalupdf.ui.screen.DashboardScreen
import com.njagakneai.panjalupdf.ui.screen.MergePdfScreen
import com.njagakneai.panjalupdf.ui.screen.PermissionsScreen
import com.njagakneai.panjalupdf.ui.screen.SplashScreen
import com.njagakneai.panjalupdf.ui.screen.HistoryScreen
import com.njagakneai.panjalupdf.ui.screen.LoginScreen
import com.google.firebase.auth.FirebaseAuth
import androidx.compose.animation.AnimatedContentTransitionScope
import androidx.compose.animation.core.tween
import androidx.compose.animation.fadeIn
import androidx.compose.animation.fadeOut
import com.njagakneai.panjalupdf.ui.screen.SettingsScreen
    ...
    NavHost(
        ...
        composable(
            ...
            DashboardScreen(
                ...
                onNavigateToPreviewKhs = {
                    navController.navigate(Screen.PreviewKhs.route)
                }
            )
        }
        ...
        composable(
            ...
            com.njagakneai.panjalupdf.ui.screen.ImageToPdfScreen(
                onNavigateBack = {
        ...
        composable(
            ...
            com.njagakneai.panjalupdf.ui.screen.PdfToImageScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
        ...
        composable(
            route = Screen.PreviewKhs.route,
            enterTransition = { slideIntoContainer(AnimatedContentTransitionScope.SlideDirection.Left, animationSpec = tween(300)) },
            exitTransition = { fadeOut(animationSpec = tween(300)) },
            popEnterTransition = { fadeIn(animationSpec = tween(300)) },
            popExitTransition = { slideOutOfContainer(AnimatedContentTransitionScope.SlideDirection.Right, animationSpec = tween(300)) }
        ) {
            com.njagakneai.panjalupdf.ui.screen.PreviewKhsScreen(
                onNavigateBack = {
                    navController.popBackStack()
                }
            )
        ...
        composable(
            ...
            com.njagakneai.panjalupdf.ui.screen.EditImageScreen(
                imageUri = imageUri,
        ...
        composable(
            ...
            com.njagakneai.panjalupdf.ui.screen.SuccessScreen(
                pdfUriString = uri,
                onBackToDashboard = {
                    navController.navigate(Screen.Dashboard.route) {
                        popUpTo(0) { inclusive = true }
...
sealed class Screen(val route: String) {
    ...
    object PreviewKhs : Screen("preview_khs")
