package com.njagakneai.panjalupdf.utils
...
object PdfMergerEngine {
    ...
    suspend fun mergeDocuments(
        ...
        val quality = if (compressionLevel == com.njagakneai.panjalupdf.data.model.CompressionLevel.SUPER) 60 else 75
            ...
            for (doc in documents) {
                when (doc.type) {
                    DocumentType.IMAGE -> {
                        ...
                        if (compressionLevel == com.njagakneai.panjalupdf.data.model.CompressionLevel.SUPER && bitmap.width > 1500) {
